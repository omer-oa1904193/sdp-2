...
export class Migration20230517180540 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "map_elective_package_study_plan" ("id" serial primary key, "elective_package_id" int not null, "study_plan_id" int null, "season" text check ("season" in (\'Fall\', \'Winter\', \'Spring\', \'Summer\')) not null, "year" int not null, "current_course_id" int null);');
    ...
    this.addSql('create table "map_course_study_plan" ("id" serial primary key, "course_id" int not null, "study_plan_id" int null, "season" text check ("season" in (\'Fall\', \'Winter\', \'Spring\', \'Summer\')) not null, "year" int not null, "category" text check ("category" in (\'Major Course\', \'CCP Course\', \'College Requirement\', \'Major Supporting\', \'Major Elective\', \'Other\')) not null);');
    ...
    this.addSql('create table "map_user_shared_study_plan" ("id" serial primary key, "user_shared_with_id" int not null, "study_plan_id" int null);');
    ...
    this.addSql('create table "comment" ("id" serial primary key, "text" text not null, "time_posted" timestamptz(0) not null default now(), "study_plan_id" int null, "author_id" int not null);');
    ...
    this.addSql('alter table "map_elective_package_study_plan" add constraint "map_elective_package_study_plan_study_plan_id_foreign" foreign key ("study_plan_id") references "study_plan" ("id") on delete cascade;');
    ...
    this.addSql('alter table "map_course_study_plan" add constraint "map_course_study_plan_study_plan_id_foreign" foreign key ("study_plan_id") references "study_plan" ("id") on delete cascade;');
    ...
    this.addSql('alter table "map_user_shared_study_plan" add constraint "map_user_shared_study_plan_study_plan_id_foreign" foreign key ("study_plan_id") references "study_plan" ("id") on delete cascade;');
    ...
    this.addSql('alter table "comment" add constraint "comment_study_plan_id_foreign" foreign key ("study_plan_id") references "study_plan" ("id") on delete cascade;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "map_user_shared_study_plan" drop constraint "map_user_shared_study_plan_user_shared_with_id_foreign";');
    ...
    this.addSql('alter table "map_user_shared_study_plan" drop constraint "map_user_shared_study_plan_study_plan_id_foreign";');
