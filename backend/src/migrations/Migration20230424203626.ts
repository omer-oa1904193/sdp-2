...
export class Migration20230424203626 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "map_elective_package_program" add constraint "map_elective_package_program_elective_package_id_p_9df7d_unique" unique ("elective_package_id", "program_id");');
    ...
    this.addSql('alter table "map_elective_package_study_plan" add constraint "map_elective_package_study_plan_elective_package_i_b4ad2_unique" unique ("elective_package_id", "study_plan_id");');
